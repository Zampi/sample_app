  ...
  describe "password encryption" do
    ...
    describe "authenticate method" do
      ...
      it "should return nil for an email address without user" do
        email  = ('a'..'z').to_a[1..10].shuffle.join('') + "@"
        email += ('a'..'z').to_a[1..5].shuffle.join('') + ".ru"
        nonexistend_user = User.authenticate(email, @attr[:password])
        nonexistend_user.should be_nil
      end
